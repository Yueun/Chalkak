package kr.ac.pusan.chalkak.data;

import android.content.Context;
import android.content.res.TypedArray;

import kr.ac.pusan.chalkak.R;
import kr.ac.pusan.chalkak.model.CardViewImg;
import kr.ac.pusan.chalkak.model.Image;
import kr.ac.pusan.chalkak.model.Inbox;
import kr.ac.pusan.chalkak.model.MusicAlbum;
import kr.ac.pusan.chalkak.model.MusicSong;
import kr.ac.pusan.chalkak.model.People;
import kr.ac.pusan.chalkak.model.ShopCategory;
import kr.ac.pusan.chalkak.model.ShopProduct;
import kr.ac.pusan.chalkak.model.Social;
import kr.ac.pusan.chalkak.utils.MaterialColor;
...
public class DataGenerator {
    ...
    public static List<Integer> getFilterImages(Context ctx) {
        List<Integer> items = new ArrayList<>();
        TypedArray drw_arr = ctx.getResources().obtainTypedArray(R.array.sample_filter_images);
        for (int i = 0; i < drw_arr.length(); i++)
            items.add(drw_arr.getResourceId(i, -1));
        return items;
    }
